...
\section{Technological choices}\label{sec:technological_choices}
	...
	\begin{itemize}
		...
		\item \textit{Front-end}: we chose \textit{NodeJS} since, like for the database, some group components had previous experience with it.
	\end{itemize}
...
\section{Architecture}\label{sec:architecture}
	...
	\subsection{Nodes}
		...
		\begin{verbatim}
{  
   "uuid":"ff0a1bda-34b9-11eb-b339-98fa9b2194f9",
   "position":[1, 5],
   "infected":false,
   "timestamp":"2020-12-02 16:19:36.945151",
   "alive":true
}  
		\end{verbatim}
...
tmp
	...
	\subsection{Front-end}
		...
		The front-end of the project, programmed using NodeJS, shows the evolution of the system and the simulations.
...
\section{Scalability and fault tolerance}
	...
	\begin{itemize}
		...
		\item \hl{\textit{adding more nodes}:}
	\end{itemize}
